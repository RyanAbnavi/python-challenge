...
with open(txtpath, 'w') as text:
    ...
    text.write('Greatest Increase in Profit:'+ greatest_increase_date +' (%d\r' %greatest_increase+")\n")
    text.write('Greatest Decrease in Profit:'+ greatest_decrease_date +' (%d\r' %greatest_decrease+")\n")
